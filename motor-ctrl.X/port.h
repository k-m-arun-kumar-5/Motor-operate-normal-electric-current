...
#define R_RMS_MAX_LIMIT_CURRENT_LED_TRIS     TRISBbits.TRISB1
#define R_RMS_MIN_LIMIT_CURRENT_LED_TRIS     TRISBbits.TRISB2 
#define MOTOR_CTRL_TRIS                      TRISBbits.TRISB3 

#define R_RMS_MAX_LIMIT_CURRENT_LED_PIN           RB1
#define R_RMS_MIN_LIMIT_CURRENT_LED_PIN           RB2
